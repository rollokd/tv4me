...
function EpisodeItem({ episode }: { episode: Episode | undefined }) {
  return (
    <div className="flex flex-col w-1/3 bg-gray-950 rounded-md">
      ...
      {episode ? (
        <div className="flex flex-col mt-2 gap-3 p-3 items-center text-center bg-gray-950 text-white overflow-y-auto border-2 border-white rounded-md h-full">
        ...
        <div className="flex flex-col gap-3 p-3 items-center text-center bg-gray-950 text-white overflow-y-auto border-2 border-white rounded-md h-full">
          <p>Hmm...?</p>
