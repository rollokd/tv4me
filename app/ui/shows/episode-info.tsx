...
function EpisodeItem({ episode }: { episode: Episode | undefined }) {
  return (
    <div className="flex flex-col w-1/3 rounded-md">
      <h1 className="text-2xl sticky top-0 px-3 pt-3 pb-1">Description</h1>
      {episode ? (
        <div className="flex flex-col mt-2 gap-3 p-3 items-center text-center overflow-y-auto border-2 rounded-md h-full">
        ...
        <div className="flex flex-col gap-3 p-3 items-center text-center overflow-y-auto border-2 rounded-md h-full">
          <p>Hmm...?</p>
