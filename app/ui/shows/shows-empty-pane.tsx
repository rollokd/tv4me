...
export default function ShowsEmptyPane() {
  return (
    <Card className="h-full border-border/70 bg-card/85 shadow-[0_24px_70px_-50px_color-mix(in_oklab,var(--color-accent)_25%,transparent)]">
      <CardContent className="flex h-full min-h-[420px] p-6 md:p-8">
